...
기계공학, 전자공학, 화학공학 대학생을 위한 직무역량 교육 로드맵입니다. 학생이 관심 직무를 채용공고 수준으로 고르면 필요한 역량 워드클라우드, 직무확보 진단, 추천 교육자료 우선순위, 기간 맞춤 로드맵, 내 계획 내보내기를 확인할 수 있습니다.
